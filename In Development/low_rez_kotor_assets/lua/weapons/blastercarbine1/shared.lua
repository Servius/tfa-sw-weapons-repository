...
SWEP.PrintName = "BlasterCarbine1"
...
function SWEP:Initialize()
	if CLIENT then
		self.VElements =
		{
			["blastercarbine"] = { type = "Model", model = "models/weapons/bc_1.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-15.065, 1.557, -1.558), angle = Angle(0, 180, 0), size = Vector(1.144, 1.144, 1.144), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}

		self.WElements =
		{
			["blastercarbine"] = { type = "Model", model = "models/weapons/bc_1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, -0.519), angle = Angle(180, 0, 0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}
