...
function SWEP:Initialize()
	if CLIENT then
		self.VElements =
		{
			["blaster"] = { type = "Model", model = "models/weapons/dp_2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, -0.519), angle = Angle(180, 0, 0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}

		self.WElements =
		{
			["blaster"] = { type = "Model", model = "models/weapons/dp_2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 2, -0.519), angle = Angle(176.494, 0, 0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}
