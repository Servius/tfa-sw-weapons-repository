...
SWEP.IronSightsPos = Vector(-3.92, -4, 1.3)
...
SWEP.Primary.RPM				= 60/0.165					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= nil					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Burst				= 60/0.165					-- RPM for burst fire, overrides semi.  This is in Rounds Per Minute / RPM
...
SWEP.VElements = {
    ["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "A280", rel = "", pos = Vector(-0.1, -02.0, 06.7), angle = Angle(360, 90, 0), size = Vector(0.299, 0.299, 0.299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
