...
SWEP.PrintName				= "DH17"		-- Weapon name (Shown on HUD)
...
SWEP.VElements = {
	["element_dh17t"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0, 4.185, 04.58), angle = Angle(0, -90, 0), size = Vector(0.299, 0.299, 0.299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
