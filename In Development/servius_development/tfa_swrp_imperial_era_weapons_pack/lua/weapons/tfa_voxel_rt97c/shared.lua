...
SWEP.PrintName				= "RT-97C"		-- Weapon name (Shown on HUD)
...
SWEP.VElements = {
    ["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_rt97c_reference001", rel = "", pos = Vector(0, 18.405, 5.98), angle = Angle(0, 90, 0), size = Vector(.340, .340, .340), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
-- Blowback Stuff --
