...
SWEP.PrintName				= "DLT-20A"		-- Weapon name (Shown on HUD)
...
SWEP.VElements = {
    ["rt scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt20a_reference001", rel = "", pos = Vector(0, 4.636, 6.175), angle = Angle(0, 90, 0), size = Vector(0.31, 0.31, 0.31), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
