SWEP.Gun					= ("e5s_sniper_rifle") --Make sure this is unique.  Specically, your folder name.  
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "TFA Star Wars: CIS" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..  
SWEP.Manufacturer = nil --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "ahnok" --Author Tooltip
SWEP.Contact				= "http://www.steamcommunity.com/id/theforgottenarchitect" --Contact Info Tooltip
SWEP.Purpose				= "Sniping, Assault" --Purpose Tooltip
SWEP.Instructions				= "Left-click to fire; Right-click to aim" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "E-5s Sniper Rifle"		-- Weapon name (Shown on HUD)	
...
--[[WEAPON HANDLING]]--
--Firing related
SWEP.Primary.Sound 			= Sound("weapons/e5s_sniper_rifle/e5s_fire.ogg")				-- This is the sound of the weapon, when you shoot.
...
--Firing Cone Related
SWEP.Primary.Spread		= .0015					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.TracerName 		= "rw_sw_laser_red" 	--Change to a string of your tracer name.  Can be custom.						--There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
