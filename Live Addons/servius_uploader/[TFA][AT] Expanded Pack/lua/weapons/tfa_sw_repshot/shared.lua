...
SWEP.Primary.HullSize = 0.8 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
...
SWEP.TracerName 		= "rw_sw_laser_blue" 	--Change to a string of your tracer name.  Can be custom.
