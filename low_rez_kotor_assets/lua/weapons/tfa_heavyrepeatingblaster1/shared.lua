...
SWEP.PrintName = "HeavyRepeatingBlaster1"
...
function SWEP:Initialize()
	if CLIENT then
		self.VElements = {
			["heavyrepeater"] = { type = "Model", model = "models/weapons/hrb_1.mdl", bone = "ValveBiped.Bip01", rel = "", pos = Vector(-5.715, -23.378, 11.947), angle = Angle(-94.676, 0, -90), size = Vector(1.274, 1.274, 1.274), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}

		self.WElements = {
			["heavyrepeater"] = { type = "Model", model = "models/weapons/hrb_1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.714, 2.596, -5.715), angle = Angle(-180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}
