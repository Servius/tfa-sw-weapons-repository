...
SWEP.PrintName				= "DC-15A Fall Camo"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/fallcam/v_dc15a.mdl"
SWEP.WorldModel				= "models/fallcam/w_dc15a.mdl"
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/fallcam/v_dc15a.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-0.011, -2.924, -5.414), angle = Angle(180, 0, -89.595), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
