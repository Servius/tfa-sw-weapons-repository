...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "Detonator: Large"			
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/props/starwars/weapons/hoth_bomb.mdl", bone = "v_weapon.famas", rel = "", pos = Vector(2, 6, 14), angle = Angle(180	, 0, -94), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/props/starwars/weapons/hoth_bomb.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 1.5, 4), angle = Angle(0, 90, 190), size = Vector(.7, .8, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
