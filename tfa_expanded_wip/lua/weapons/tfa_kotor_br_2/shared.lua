...
SWEP.IronSightsPos = Vector(-6.95, -7, -1.25)
...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.awm_parent", rel = "element_gun", pos = Vector(12.1, -0.731, 6.445), angle = Angle(0, 0, -90), size = Vector(0.34, 0.34, 0.34), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
...
SWEP.RTCode = function( self, mat )
	...
	if AngPos then
		...
		ang:RotateAroundAxis(ang:Right(), -2.25)
...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.awm_parent", rel = "element_gun", pos = Vector(12, -0.75, 6.4), angle = Angle(0, 0, 0), size = Vector(0.379, 0.379, 0.379), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["element_gun"] = { type = "Model", model = "models/w_blstrrfl_002.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-1.558, -3.636, -8.832), angle = Angle(87.662, -1.17, -85.325), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
