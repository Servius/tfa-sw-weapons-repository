...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/w_blstrrfl_002.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-2, -4, -2), angle = Angle(90, -92, -0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name2"] = { type = "Model", model = "models/w_blstrrfl_002.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(12, 2, -3.6 	), angle = Angle(10, -180, 180), size = Vector(.85, .85, .85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
