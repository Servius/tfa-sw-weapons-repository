...
SWEP.IronSightsPos = Vector(-4, -4, 1.72)
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/w_hvyblstr_002.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(-0.601, -5.7, 0.899), angle = Angle(-1.17, -89, 3.506), size = Vector(0.755, 0.755, 0.755), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/w_hvyblstr_002.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(-0.601, -5.7, 0.899), angle = Angle(-1.17, -82.987, 3.506), size = Vector(0.755, 0.755, 0.755), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
