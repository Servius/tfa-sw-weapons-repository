SWEP.Gun					= ("tfa_sw_dlt20a") --Make sure this is unique.  Specically, your folder name.  
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "TFA Star Wars Battlefront" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..  
SWEP.Manufacturer = nil --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Lightcruiser & elitelukas" --Author Tooltip
...
SWEP.PrintName				= "DLT20a Sniper"		-- Weapon name (Shown on HUD)	
...
SWEP.TracerName 		= "effect_sw_laser_green_sniper" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/weapons/synbf3/c_dlt20a.mdl", bone = "v_weapon.AK47_Parent", rel = "", pos = Vector(0.065, -5.45, 2.28), angle = Angle(90, 180, 0), size = Vector(0.333, 0.333, 0.333), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["wep"] = { type = "Model", model = "models/weapons/synbf3/c_dlt20a.mdl", bone = "v_weapon.AK47_Parent", rel = "", pos = Vector(-0.049, 0.875, -8.695), angle = Angle(-87.015, 88.999, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/synbf3/c_dlt20a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.164, 1.521, 0.76), angle = Angle(-15.735, -5, 178), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
