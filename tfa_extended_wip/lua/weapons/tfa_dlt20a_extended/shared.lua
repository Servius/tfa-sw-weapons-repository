...
SWEP.IronSightsPos = Vector(-4.08, -12.865, 2.319)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt20a_reference001", rel = "", pos = Vector(-0.02, 4.699, 6.199), angle = Angle(-180, -90, 0), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
