...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dh17_reference001", rel = "element_reference", pos = Vector(-8.921, 0.289, 1.639), angle = Angle(0, -180, 180), size = Vector(0.27, 0.27, 0.27), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
...
SWEP.RTCode = function( self, mat )
	...
	if AngPos then
		...
		ang:RotateAroundAxis(ang:Right(), 1.7)
...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dh17_reference001", rel = "element_reference", pos = Vector(-8.921, 0.289, 1.639), angle = Angle(0, -180, 0), size = Vector(0.27, 0.27, 0.27), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["element_reference"] = { type = "Model", model = "models/weapons/w_dl44.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(1, -5, 2.596), angle = Angle(1.169, 87.662, 1.169), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.IronSightsPos = Vector(-4.389, -9.631, 2.16)
SWEP.IronSightsAng = Vector(1.7, 9.109, 0)
--]]