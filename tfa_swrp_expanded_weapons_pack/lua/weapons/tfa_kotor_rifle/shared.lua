...
SWEP.IronSightsPos = Vector(-7.56, -8, 1.08)
...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.awm_parent", rel = "element_name", pos = Vector(-7.65, -0.96, 3.75), angle = Angle(0, -180, -90), size = Vector(0.247, 0.247, 0.247), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
