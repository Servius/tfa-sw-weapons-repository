...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dh17_reference001", rel = "element_reference", pos = Vector(-10.29, -0.473, 3.039), angle = Angle(0, -180, 180), size = Vector(0.168, 0.168, 0.168), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
...
SWEP.RTCode = function( self, mat )
	...
	if AngPos then
		...
		ang:RotateAroundAxis(ang:Up(), 3.9)
...
SWEP.IronSightsPos = Vector(-4.16, -9.631, 0.86)
