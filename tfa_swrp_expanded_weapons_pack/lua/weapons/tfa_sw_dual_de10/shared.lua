...
SWEP.Primary.Sound 			= Sound("weapons/DE10_fire.wav")				-- This is the sound of the weapon, when you shoot.

SWEP.Callback = {}
SWEP.Callback.ChooseProceduralReloadAnim = function(self)
	self:EmitSound("weapons/DE10_reload.wav")
end
