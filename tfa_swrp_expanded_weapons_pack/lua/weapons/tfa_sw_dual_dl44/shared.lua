...
SWEP.Primary.Sound 			= Sound("weapons/DL44_fire.wav")				-- This is the sound of the weapon, when you shoot.

SWEP.Callback = {}
SWEP.Callback.ChooseProceduralReloadAnim = function(self)
	self:EmitSound("weapons/DL44_reload.wav")
end
