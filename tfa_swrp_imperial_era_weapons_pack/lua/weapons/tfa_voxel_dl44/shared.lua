...
SWEP.Instructions = "Always shoot first"
...
SWEP.Primary.IronAccuracy = .0000000001	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dl44_reference001", rel = "", pos = Vector(1.5, 2.5, 3.73), angle = Angle(0, -90, 0), size = Vector(0.3299, 0.3299, 0.3299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
