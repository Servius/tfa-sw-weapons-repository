...
SWEP.PrintName				= "Scoutblaster"		-- Weapon name (Shown on HUD)
...
SWEP.VElements = {
    ["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(01.362, 2.885, 01.7), angle = Angle(180, 90, 180), size = Vector(0.299, 0.299, 0.299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
