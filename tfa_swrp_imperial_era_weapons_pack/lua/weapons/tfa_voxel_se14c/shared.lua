...
SWEP.VElements = {
    ["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_se14c_reference001", rel = "", pos = Vector(0.07, 9., 04.3), angle = Angle(180, 90, 180), size = Vector(0.200, 0.200, 0.200), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
