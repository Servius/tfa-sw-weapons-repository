SWEP.Gun					= ("tfa_voxel_smartrocket") --Make sure this is unique.  Specically, your folder name.
...
SWEP.VElements = {
	["models/nate159/swbf2015/pewpew/rocketlauncher.mdl"] = { type = "Model", model = "models/nate159/swbf2015/pewpew/rocketlauncher.mdl", bone = "v_weapon.famas", rel = "", pos = Vector(1.557, -0.519, 23.398), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
